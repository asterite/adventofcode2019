...
class Chemical
  ...
  # This is *the* difference between part 1: we use
  # float because we'll use left overs.
...
chemicals.each do |chemical|
  ...
  # Here we don't round because we'll be using left-over
  multiplier = chemical.quantity / reaction.output.quantity
...
puts (1000000000000 / chemicals_by_name["ORE"].quantity).floor.to_i
